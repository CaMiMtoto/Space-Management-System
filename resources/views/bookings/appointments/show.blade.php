                ...
                <div class="card card-body border-dashed my-3">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-lg-4">
                            ...
                            <div
                                class="form-control-plaintext">{{ $appointmentBooking->date->format('M d, Y') }}</div>
                        </div>
                        ...
                        <div class="col-md-6 col-lg-4">
                            ...
                            <div class="form-control-plaintext">{{ $appointmentBooking->contact_person_name??'N/A' }}</div>
                        </div>
                        <div class="col-md-6 col-lg-4">
                            <label class="form-label">Contact Person Email:</label>
                            <div class="form-control-plaintext">{{ $appointmentBooking->contact_person_email??'N/A' }}</div>
                        </div>
                        <div class="col-md-6 col-lg-4">
                            <label class="form-label">Contact Person Phone:</label>
                            <div class="form-control-plaintext">{{ $appointmentBooking->contact_person_phone??'N/A' }}</div>
                        </div>
                    </div>
                </div>
